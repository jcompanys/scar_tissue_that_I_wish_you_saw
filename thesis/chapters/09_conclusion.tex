...
feature vectors can present fundamentally different scar geometries. In this cohort, the data did not support a tractable parametric description of the joint
scar geometry distribution. This sharpens the problem: what is needed is not a generative
...
case---and establishes the descriptive foundation that any future generative model will need
to build on.
