...
LV meshes to a common template and mapping scar labels through the deformation field \cite{doste2026}.
...
\begin{figure}[htbp]
    ...
    \caption{Polar map projection pipeline: 3D mesh input, long-axis detection and apex-down re-orientation, longitudinal coordinate $s$, circumferential angle $\theta$, and final bull's-eye map with AHA 17-segment overlay.}
