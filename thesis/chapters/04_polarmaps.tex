...
disproportionately small. Consistency between all three approaches was verified to ensure
that findings are not artefacts of the binary representation.
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.65\textwidth]{figures/M06_3d_scar_2024_07009967}
    \caption{3D LV reconstruction for representative case 2024\_07009967 used in the polar map verification. Core-zone scar (red) overlaid on the semi-transparent LV shell.}
    \label{fig:verif3d}
\end{figure}
...
\begin{figure}[htbp]
    ...
    \caption{Polar map comparison for case 2024\_07009967. Left: proposed pipeline (linear $s$ coordinate, Core Surface vertices projected directly). Right: conformal flattening method of N\'{u}\~{n}ez Garc\'{i}a \cite{nunez2018} ($r^{1/3}$ radial remapping, endocardial proximity labelling). Scar localisation is consistent; differences in radial density and apical coverage reflect distinct mapping choices rather than anatomical disagreement.}
