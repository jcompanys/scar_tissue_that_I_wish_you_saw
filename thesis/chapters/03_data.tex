...
This section describes the clinical and imaging-derived dataset used throughout this work,
the selection criteria applied to obtain the analysis cohort, and the data structures available
for each patient case. All cases originate from the DEVELOP-VT registry, a multicentre
prospective collection of post-myocardial infarction patients undergoing ventricular
tachycardia (VT) risk assessment. The primary acquisition and processing centre is
Centro M\'{e}dico Teknon (Barcelona, Spain).

\subsection{The DEVELOP-VT Registry and Clinical Context}
...
\subsection{Data Acquisition and Processing at Teknon}
...
\subsection{Cohort Selection and Exclusion Criteria}
...
\subsection{Available Data per Patient}

Each valid case provides: (i) LV shell meshes representing the endocardial and epicardial
boundaries derived from the late gadolinium enhancement cardiac magnetic resonance
(LGE-CMR) study; (ii) LGE-CMR-derived tissue classification surfaces from ADAS 3D,
primarily the core zone, with
