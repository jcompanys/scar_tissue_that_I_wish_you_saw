...
Data extraction was performed on-site at Centro M\'{e}dico Teknon's computer system. With
the help of technicians and clinicians, I learned to use ADAS 3D and gained a detailed
understanding of the segmentation workflow: how scar appears under different acquisition
conditions, how tissue thresholds are adjusted, and how the resulting 3D models relate to
the underlying cardiac anatomy. Beyond the left ventricle, this experience also provided
exposure to left atrial ablation workflows and different arrhythmia types, including atrial
fibrillation and typical and atypical flutter.

A significant practical contribution of this project was centralising the dataset, which had
previously been distributed across different storage locations within the hospital system, and
assisting in the segmentation of approximately 40 new cases. This work served not only to
expand the cohort but also to develop a first-hand understanding of the clinical data that
informs all subsequent modelling decisions.
...
arrhythmia variables, and follow-up outcomes. A detailed description of the clinical metadata
fields is provided in Annex~\ref{app:supplementary}. Sex information was available for 48 of the
105 valid patients, with a predominantly male distribution consistent with the epidemiology of
myocardial infarction. Age was available for a subset of 48 patients (mean
$63.0 \pm 11.5$ years). The high rate of missingness in key variables limits stratified analyses
and motivates the use of the full cohort without clinical sub-grouping.
...
\begin{figure}[htbp]
    ...
    \caption{Quality-control grid of all 105 valid cases. Each thumbnail shows the LV shell (semi-transparent) with core-zone scar overlay (opaque red) from an isometric viewpoint. The grid confirms geometric coherence across the cohort and illustrates the wide range of scar extent, location, and morphology.}
    \label{fig:qc_grid}
\end{figure}
