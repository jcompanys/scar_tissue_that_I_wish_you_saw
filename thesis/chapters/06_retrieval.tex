...
The previous sections established a compact geometric characterization of post-infarction
scar. This section presents a retrieval-based generation (RBG) framework that leverages
...
\subsection{Scar Descriptor Space}
...
\subsection{Similarity Metric, Retrieval Strategy, and Evaluation Framework}
